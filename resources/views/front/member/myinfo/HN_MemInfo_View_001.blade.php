    ...
    <div class="wrap-login customer">
      <div class="login-cont myinfo">
        <form action="" class="form-login">
          ...
          <div class="wrap-btn">
            <button type="button" class="btn primary h56 full" onclick="location.href='{{ route('front.myinfo_edit') ?? '#' }}'">
              <span>나의 정보 수정</span>
            </button>
            <button type="button" class="btn primary h56 full" onclick="location.href='{{ route('front.change_password') ?? '#' }}'">
              <span>비밀번호 변경</span>
            </button>
          </div>
        </form>
