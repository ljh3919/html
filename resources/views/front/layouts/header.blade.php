      ...
      <div class="wrap-menu-mo">
        <div class="menu-header">
          @if(!auth()->guard('member')->check())
            <a href="{{ route('front.join01') }}" class="account-item"><span>회원가입</span></a>
            <a href="{{ route('front.login') }}" class="account-item">
              <span>로그인</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          @else
            <a href="{{ route('front.myinfo') }}" class="account-item"><span>나의정보</span></a>
            <a href="javascript:void(0)" onclick="document.getElementById('logout-form-mo').submit();" class="account-item">
              <span>로그아웃</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
