        ...
        <div class="card-body p-0">
            <form id="popup-form" action="{{ route('admin.popup.update', $popup->id) }}" method="POST">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="table-cell-custom">
                                    <input type="text" name="title" class="form-control form-control-sm" value="{{ old('title', $popup->title) }}" placeholder="팝업 제목을 입력하세요">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="table-cell-custom">
                                    <div class="d-flex align-items-center">
                                        <input type="date" name="start_date" class="form-control form-control-sm w-auto mr-2" value="{{ old('start_date', $popup->start_at->format('Y-m-d')) }}">
                                        ...
                                        <input type="date" name="end_date" class="form-control form-control-sm w-auto mr-2" value="{{ old('end_date', $popup->end_at->format('Y-m-d')) }}">
                            ...
                            <tr>
                                ...
                                <td class="table-cell-custom p-3" style="background-color: #fcfcfc;">
                                    <textarea name="content" id="editor" class="form-control">{{ old('content', $popup->content) }}</textarea>
                                </td>
                            </tr>
                            <tr>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4 mb-5">
                    ...
                    <div class="d-flex">
                        <a href="{{ route('HNA_Popup_Detail_001', $popup->id) }}" class="btn btn-sm btn-outline-custom px-4 py-2 mr-2" style="min-width: 80px;">취소</a>
