    ...
    <table class="table board-table vertical-table">
        <tr>
            ...
            <td>
                ...
                <div class="text-info mt-1">* 영문 또는 영문+숫자만 가능</div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                @php
                    $phoneParts = [old('phone_part1', '010'), old('phone_part2'), old('phone_part3')];
                @endphp
                <div class="wrap-form">
                    <div class="input-group h30">
        ...
        <tr>
            ...
            <td>
                @php
                    $emailUser = old('email_user');
                    $emailDomain = old('email_domain');
                @endphp
                <div class="wrap-form">
                    <div class="input-group h30">
                        <input type="text" name="email_user" class="input-box" value="{{ $emailUser }}" required />
                    </div>
                    <span class="mx-1">@</span>
                    <div class="input-group h30">
                        <input type="text" name="email_domain" id="email-domain" class="input-box" value="{{ $emailDomain }}" required />
                    </div>
