...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">관리자사이트 > 공지사항 관리 > 등록</h1>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.notice.store') }}" method="POST" enctype="multipart/form-data" id="noticeForm">
                ...
                <div class="form-group row border-bottom pb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="공지사항 제목을 입력하세요">
                    </div>
                </div>
                ...
                <div class="text-center mt-5">
                    ...
                    <a href="{{ route('HNA_Customer_Noticelist_001') }}" class="btn btn-secondary px-5">취소</a>
                </div>
            </form>
        </div>
    </div>
