...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">관리자사이트 > 팝업 관리 > 수정</h1>
    </div>
        ...
        <div class="card-body">
            <form id="popup-form" action="{{ route('admin.popup.update', $popup->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="title" class="form-control" value="{{ old('title', $popup->title) }}" placeholder="팝업 제목을 입력하세요">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 d-flex align-items-center">
                        <input type="date" name="start_date" class="form-control w-auto mr-2" value="{{ old('start_date', $popup->start_at->format('Y-m-d')) }}">
                        ...
                        <input type="date" name="end_date" class="form-control w-auto mr-2" value="{{ old('end_date', $popup->end_at->format('Y-m-d')) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="content" id="content" class="form-control" rows="10" placeholder="팝업 내용을 입력하세요">{{ old('content', $popup->content) }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-control custom-switch mt-2">
                            <input type="checkbox" name="is_visible" class="custom-control-input" id="is_visible" {{ $popup->is_visible ? 'checked' : '' }}>
                ...
                <div class="text-center mt-5">
                    ...
                    <a href="{{ route('HNA_Popup_Detail_001', $popup->id) }}" class="btn btn-secondary px-5">취소</a>
                </div>
            </form>
        </div>
    </div>
