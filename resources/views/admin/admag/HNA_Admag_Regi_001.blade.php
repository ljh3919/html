...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">관리자 관리 > 등록</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('admin.admag.store') }}" method="POST" id="regi-form">
                @csrf
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('HNA_Admag_list_001') }}" class="btn btn-secondary px-5 ml-2">취소</a>
                </div>
