...
<table class="table board-table vertical-table">
    ...
    <tr>
        ...
        <td>
            ...
            <div style="white-space: pre-wrap; line-height: 1.6;">{{ $letter->content }}</div>
        </td>
    </tr>
    <tr>
        <th>작성자</th>
    ...
    <tr>
        ...
        <td>
            @if($letter->is_private == 'Y')
                <span class="text-danger font-weight-bold">Y</span>
            @else
                N
            @endif
        </td>
...
<div class="wrap-board-btn">
    ...
    <div class="wrap-btn-right">
        <button type="button" class="btn line small" onclick="location.href='{{ route('HNA_Lettermag_List_001') }}'">
            <span>목록</span>
        </button>
        <button type="button" class="btn line small" onclick="deleteLetter()">
            <span>삭제</span>
