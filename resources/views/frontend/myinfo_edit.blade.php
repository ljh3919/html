...
<main>
  <div class="main">
    <div class="breadcrumb">
      ...
      <a href="{{ route('frontend.myinfo_edit') ?? '#' }}" class="item">나의 정보 수정</a>
    </div>
    <div class="wrap-tit">
          ...
          <div class="wrap-form-item">
            ...
            <div class="input-group">
              @php
                  ...
                  $p3 = $phoneParts[2] ?? '';
              @endphp
              <div class="wrap-phone-inputs" style="display: flex; align-items: center; gap: 8px;">
                <input type="text" id="phone1" class="input-box" style="width: 80px;" value="{{ $p1 }}" maxlength="3">
                <span>-</span>
                <input type="text" id="phone2" class="input-box" style="width: 80px;" value="{{ $p2 }}" maxlength="4">
                <span>-</span>
                <input type="text" id="phone3" class="input-box" style="width: 80px;" value="{{ $p3 }}" maxlength="4">
              </div>
            </div>
          </div>
          <div class="wrap-form-item">
...
<script>
  ...
  function validateEditForm() {
    ...
    // PPT Slide 31 requirement: check if phone or email is missing
    if (!p1 || !p2 || !p3 || !e1 || !e2) {
    ...
    fetch("{{ route('frontend.myinfo_edit.post') }}", {
      method: "POST",
      headers: {
